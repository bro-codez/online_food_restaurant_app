          ...
          <div className="bg-white_A700 flex items-center justify-start max-w-[1112px] mx-[auto] my-[76px] md:px-[20px] py-[38px] rounded-[16px] w-[100%]">
            <div className="mb-[26px] overflow-x-auto w-[100%]">
              <div className="flex flex-col justify-start w-[100%]">
                ...
                >
                  <div className="flex flex-col items-start justify-start md:ml-[0] ml-[20px] mt-[54px] md:w-[100%] w-[62%]">
                    <Text
                    ...
                    <div className="flex sm:flex-col flex-row gap-[16px] items-center justify-start mt-[28px] md:w-[100%] w-[85%]">
                      <Img
                    ...
                    <div className="flex flex-row gap-[16px] items-start justify-start mt-[12px] md:w-[100%] w-[38%]">
                      <Img
                ...
                <div className="flex md:flex-col flex-row font-poppins md:gap-[20px] items-center justify-start md:ml-[0] ml-[34px] mt-[48px] md:w-[100%] w-[95%]">
                  ...
                  <div className="flex flex-col gap-[20px] items-center justify-start md:ml-[0] ml-[112px] md:w-[100%] w-[24%]">
                    <Button
                      className="cursor-pointer font-normal min-w-[246px] not-italic text-[20px] text-center text-indigo_900 w-[auto]"
                    ...
                    <Button
                      className="common-pointer cursor-pointer font-normal min-w-[246px] not-italic text-[20px] text-center text-red_A700 w-[auto]"
